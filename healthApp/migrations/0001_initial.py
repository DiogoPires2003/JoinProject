# Generated by Django 4.2.20 on 2025-04-10 11:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insurance_number', models.CharField(blank=True, error_messages={'unique': 'Ya existe un paciente con este número de seguro.'}, max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='El número de seguro debe comenzar con una letra seguida de 5 dígitos', regex='^[A-Za-z]\\d{5}$')])),
